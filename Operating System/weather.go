...
func showWeatherApp() {
	...
	//api part
	res, err := http.Get("https://api.openweathermap.org/data/2.5/weather?q=delhi&units=metric&appid=29cd62b0b0b5832635f75228e9957583#")
	...
	img := canvas.NewImageFromFile("weather1.png")
